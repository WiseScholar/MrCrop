"""
Django settings for crop_disease_detector project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-6y0s!i0l8ua%p6fzvb0w%p$5*ygz*#%2^&a!$=jzgh%%ht-c*%')
...
ROOT_URLCONF = 'crop_disease_detector.urls'
...
WSGI_APPLICATION = 'crop_disease_detector.wsgi.application'
